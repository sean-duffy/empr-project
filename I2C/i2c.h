...
//void i2cInit(LPC_I2C_TypeDef* addr, uint32_t clkspeed, uint8_t portNo, uint8_t pinNo);
...
//void logFunctionToSerial(LPC_I2C_TypeDef* addr, char* append, int arraySize);
